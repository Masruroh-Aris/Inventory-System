            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-2xl border-t-4 border-indigo-500">
                <div class="p-8 text-gray-900">
                    ...
                    <div class="flex justify-between items-center mb-8 border-b border-gray-100 pb-4">
                        ...
                        <a href="<?php echo e(route('stocks.index')); ?>" class="text-indigo-600 hover:text-indigo-800 font-semibold flex items-center transition hover:-translate-x-1">
                        ...
                        <div class="bg-indigo-50 p-6 rounded-2xl">
                            ...
                            <div class="space-y-3">
                                <div>
                                    ...
                                    <p class="text-lg font-semibold text-gray-800"><?php echo e($stock->product->name); ?></p>
                                </div>
                                <div>
                                    <label class="text-xs font-bold text-gray-500 uppercase">Product Code</label>
                                    <p class="text-gray-700 font-mono"><?php echo e($stock->product->code); ?></p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="bg-gray-50 p-6 rounded-2xl">
                            ...
                            <div class="space-y-3">
                                <div>
                                    ...
                                    <p class="text-gray-800 font-medium"><?php echo e($stock->date->format('d F Y')); ?></p>
                                </div>
                                <div>
                                ...
                                <div>
                                    ...
                                    <p class="text-2xl font-bold text-gray-800"><?php echo e($stock->quantity); ?> <span class="text-sm font-normal text-gray-500"><?php echo e($stock->product->unit); ?></span></p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mt-8 grid grid-cols-1 md:grid-cols-2 gap-8">
                        <div>
                            ...
                            <div class="mt-2 p-4 bg-yellow-50 border border-yellow-100 rounded-xl text-gray-700 italic">
                                "<?php echo e($stock->notes ?: 'No notes provided.'); ?>"
                            </div>
                        </div>
                            ...
                            <div class="text-right">
                                ...
                                <div class="flex items-center justify-end mt-1">
                                    <div class="h-8 w-8 rounded-full bg-indigo-100 flex items-center justify-center text-indigo-600 font-bold mr-2">
                                        <?php echo e(substr($stock->user->name, 0, 1)); ?>

                                    </div>
                                    <p class="text-gray-800 font-medium"><?php echo e($stock->user->name); ?></p>
                                </div>
                                <p class="text-xs text-gray-400 mt-1"><?php echo e($stock->created_at->format('H:i A')); ?></p>
                            </div>
                        </div>
                    </div>
...
<?php endif; ?>
<?php /**PATH E:\SEMESTER 5\Pemrograman Framework\BELAJAR\Inventory_system\resources\views/stocks/show.blade.php ENDPATH**/ ?>