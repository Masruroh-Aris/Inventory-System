...
<head>
    ...
    <title>Receipt - <?php echo e($invoice_code); ?></title>
    <style>
        body {
...
<body onload="window.print()">
    ...
    <div class="info">
        <p>Invoice: <?php echo e($invoice_code); ?></p>
        <p>Date: <?php echo e($transactions->first()->date->format('d/m/Y H:i')); ?></p>
        <p>Cashier: <?php echo e($transactions->first()->user->name); ?></p>
    </div>
    ...
    <div class="total">
        <div style="display: flex; justify-content: space-between;">
            <span>TOTAL</span>
            <span>Rp <?php echo e(number_format($transactions->sum('total_price'), 0, ',', '.')); ?></span>
        </div>
    </div>
...
<?php /**PATH E:\SEMESTER 5\Pemrograman Framework\BELAJAR\Inventory_system\resources\views/transactions/print.blade.php ENDPATH**/ ?>