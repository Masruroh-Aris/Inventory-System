    ...
    <div class="label-container">
        <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="label">
                ...
                <div class="barcode">
                    <?php echo $generator->getBarcode($product->code, $generator::TYPE_CODE_128); ?>

                </div>
                <div class="product-code"><?php echo e($product->code); ?></div>
...
<?php /**PATH E:\SEMESTER 5\Pemrograman Framework\BELAJAR\Inventory_system\resources\views/barcodes/print.blade.php ENDPATH**/ ?>