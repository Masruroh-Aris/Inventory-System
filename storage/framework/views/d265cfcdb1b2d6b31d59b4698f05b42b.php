            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-2xl border-t-4 border-indigo-500">
                <div class="p-8 text-center">
                    ...
                    <div id="printableArea" class="inline-block border-2 border-dashed border-gray-300 p-8 rounded-xl bg-gray-50 mb-8">
                        <div class="flex flex-row items-center space-x-8 text-left">
                            ...
                            <div class="flex flex-col justify-center">
                                <h3 class="text-2xl font-bold text-gray-900 mb-1"><?php echo e($product->name); ?></h3>
                                <p class="text-gray-500 font-mono text-lg mb-2"><?php echo e($product->code); ?></p>
                                
                                <div class="mt-2">
                                    <span class="text-xs font-bold text-gray-400 uppercase tracking-wider">Price</span>
                                    <p class="text-xl font-bold text-indigo-600">Rp <?php echo e(number_format($product->price, 0, ',', '.')); ?></p>
                                </div>
                                
                                <div class="mt-2">
                                    <span class="text-xs font-bold text-gray-400 uppercase tracking-wider">Category</span>
                                    <p class="text-gray-700 font-medium"><?php echo e($product->category); ?></p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="flex justify-center space-x-4 no-print">
                        <a href="<?php echo e(url()->previous()); ?>" class="px-6 py-2 bg-gray-200 text-gray-700 rounded-full hover:bg-gray-300 transition font-semibold">
                            Kembali
                        </a>
    ...
    <script>
        ...
        function downloadQR() {
            ...
            if (img && img.src) {
                ...
                link.href = img.src;
                link.download = "QR-<?php echo e($product->code); ?>.png";
...
<?php endif; ?>
<?php /**PATH E:\SEMESTER 5\Pemrograman Framework\BELAJAR\Inventory_system\resources\views/barcodes/show.blade.php ENDPATH**/ ?>