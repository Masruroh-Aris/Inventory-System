        ...
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-2xl border-t-4 border-indigo-500">
                <div class="p-8 text-gray-900">
                    ...
                    <form action="<?php echo e(route('transactions.store')); ?>" method="POST" x-data="transactionForm()">
                        <?php echo csrf_field(); ?>
                                            ...
                                            <div class="md:col-span-6">
                                                ...
                                                <select :name="'items['+index+'][product_id]'" x-model="item.product_id" @change="updatePrice(index)" class="w-full rounded-lg border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 text-sm" required>
                                                    ...
                                                    <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option value="<?php echo e($product->id); ?>" data-price="<?php echo e($product->price); ?>"><?php echo e($product->code); ?> - <?php echo e($product->name); ?> (Stock: <?php echo e($product->stock); ?>)</option>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="flex items-center justify-end space-x-4 mt-8">
                            <a href="<?php echo e(route('transactions.history')); ?>" class="text-gray-500 hover:text-gray-700 font-semibold transition duration-200">
                                Cancel
                            </a>
                    ...
                    <script>
                        function transactionForm() {
                            return {
                                ...
                                productList: <?php echo json_encode($products, 15, 512) ?>,
...
<?php endif; ?>
<?php /**PATH E:\SEMESTER 5\Pemrograman Framework\BELAJAR\Inventory_system\resources\views/transactions/create.blade.php ENDPATH**/ ?>