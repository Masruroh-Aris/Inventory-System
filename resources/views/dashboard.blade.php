<x-app-layout> 
                ...
                <div class="bg-gradient-to-br from-green-500 to-green-600 overflow-hidden shadow-lg sm:rounded-xl p-6 transform transition duration-500 hover:scale-105 hover:shadow-2xl delay-200">
                    <div class="flex items-center">
                        ...
                        <div>
                            ...
                            <p class="text-3xl font-bold text-white">Rp {{ number_format($totalStockValue, 0, ',', '.') }}</p>
                        </div>
                    </div>
                </div>
                            ...
                            <tbody class="divide-y divide-gray-200">
                                @forelse($latestTransactions as $transaction)
                                    <tr class="hover:bg-indigo-50 transition duration-150">
                                        ...
                                        <td class="py-3 px-4 font-medium text-gray-900">{{ $transaction->product->name }}</td>
                                        <td class="py-3 px-4">
                                        ...
                                        <td class="py-3 px-4 text-gray-500">{{ $transaction->user->name }}</td>
                                    </tr>
                                @empty
                                    <tr>
    ...
    <script>
        ...
        new Chart(lowStockCtx, {
            ...
            data: {
                labels: {!! json_encode($lowStockProducts->pluck('name')) !!},
                datasets: [{
                    label: 'Stock Level',
                    data: {!! json_encode($lowStockProducts->pluck('stock')) !!},
